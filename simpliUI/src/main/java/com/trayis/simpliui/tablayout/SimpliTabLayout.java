package com.trayis.simpliui.tablayout;
...
import com.trayis.simpliui.utils.AnimationUtils;
import com.trayis.simpliui.utils.ThemeUtils;
import com.trayis.simpliui.utils.ValueAnimatorCompat;
import com.trayis.simpliui.utils.ViewUtils;
 ...
 */
@ViewPager.DecorView
public class SimpliTabLayout extends HorizontalScrollView {
    ...
    public SimpliTabLayout(Context context) {
        this(context, null);
    }

    public SimpliTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SimpliTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
                ...
                if (mSelectedIndicatorWidth > 0 && mSelectedIndicatorWidth < width) {
                    int i = (width - mSelectedIndicatorWidth) / 2;
                    mIndicatorLeft += i;
                    mIndicatorRight -= i;
                }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<SimpliTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(SimpliTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final SimpliTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
